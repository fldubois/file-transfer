...
WebDAVClient.prototype.checkConnection = function () {
  return this.isConnected() ? Promise.resolve() : Promise.reject(new Error('WebDAV client not connected'));
};
...
WebDAVClient.prototype.unlink = function (remotePath, callback) {
  return this.requestAsync('DELETE', remotePath).thenReturn(null).asCallback(callback);
};
