...
WebDAVClient.prototype.propfind = function (remotePath, depth, callback) {
...
WebDAVClient.prototype.createReadStream = function (remotePath) {
  return this.request('GET', remotePath).on('response', function (response) {
...
WebDAVClient.prototype.createWriteStream = function (remotePath) {
  return this.request('PUT', remotePath).on('response', function (response) {
    if (response.statusCode >= 400) {
      var error = new Error('WebDAV request error');
...
WebDAVClient.prototype.readdir = function (remotePath, callback) {
  ...
  this.propfind(remotePath, 1, function (error, body) {
    if (error) {
      return callback(error);
    }
