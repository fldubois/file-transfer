...
FTPClient.prototype.get = function (remote, local, callback) {
  return this.checkConnection().bind(this).then(function () {
    return this.client.getAsync(remote);
...
FTPClient.prototype.unlink = function (remote, callback) {
  return this.checkConnection().bind(this).then(function () {
    return this.client.deleteAsync(remote);
  }).asCallback(callback);
};

FTPClient.prototype.readdir = function (remote, callback) {
  return this.checkConnection().bind(this).then(function () {
    return this.client.listAsync(remote);
  }).then(function (files) {
    var directory = path.basename(remote);
...
FTPClient.prototype.mkdir = function (remote, options, callback) {
  if (typeof options === 'function') {
    callback = options;
    options  = {};
  }
  ...
  return this.checkConnection().bind(this).then(function () {
    return this.client.mkdirAsync(remote);
  }).asCallback(callback);
};

FTPClient.prototype.rmdir = function (remote, callback) {
  return this.checkConnection().bind(this).then(function () {
    return this.client.rmdirAsync(remote);
  }).asCallback(callback);
};
